...
from .views import custom_login_view,forget_password_view, user_signup_view, user_profile_view,edit_profile_view,user_logout_view,change_password_view,user_management_view,all_users_view
